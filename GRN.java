...
public class GRN extends javax.swing.JFrame {
    ...
    public GRN() {
       ...
       // DefaultTableModel dtm(DefaultTableModel) jTable1.getModel();
        ...
        ResultSet rs=st.executeQuery("Select * from GRN");
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Product_Id", "ProductName", "Brand", "Quantity", "Total Price", "Supplier ID", "SupplierName", "PurchasedDate"
            }
        ));
        jScrollPane1.setViewportView(jTable1);

        panel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 30, 690, 350));

        jLabel1.setFont(new java.awt.Font("Segoe UI", 3, 18)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("GRN TABLE");
        panel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 0, 150, -1));
